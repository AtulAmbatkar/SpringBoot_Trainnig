 ...
 * authentication context if the token is valid. It uses {@link JwtService} for
 * token operations and {@link UserService} to load user details.
 * </p>
 */
@Component
public class JwtFilter extends OncePerRequestFilter {
	...
	/**
	 * Filters the incoming request to check for JWT and sets the authentication
	 * context.
	 * <p>
	 * This method extracts the JWT from the `Authorization` header, validates it,
	 * and creates an authentication token if the token is valid. The authentication
	 * token is then set in the {@link SecurityContextHolder}.
	 * </p>
	 * 
