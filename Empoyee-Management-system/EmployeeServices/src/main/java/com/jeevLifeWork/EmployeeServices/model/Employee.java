...
* This class maps to the "Rest_Employee" table in the database and includes 
* fields for employee ID, name, department, position, and salary.
*/
@Entity
...
public class Employee {
	...
	/**
	 * Employee name
	 * This field cannot be null and has a maximum length of 20 characters.
	 */
	...
	/**
	 * Employee Department
	 * This Field cannot be null and has max lenght of 20
	 */
	@Column(length=20, nullable=false)
	...
	/**
	 * Employee Salary
	 * This field cannot be null and has a maximum length of 30 characters.
	 */
	@Column(length=30, nullable=false)
	private Double salary;

	/**
	 * @param Constructor for the employee 
